...
static const char version[] = "0.2.0 20060211"; //Ne pozabi dodat vseh novih map in datotek... 11.2.2006
...
int main(int argc, char **argv)
{
    ...
    about.addCredit("Grega Štajer", I18N_NOOP("Creator of icons, logo and maintainer of (K)Ubuntu binary packages"), "grega.stajer@email.si", "http://blender.kicks-ass.net");
